...
{
    internal interface IBookingSystem //Bokningsystem som ska kunna implementeras i en rad olika situationer, Biograf, Bowlingbana, hotelrum, bordsbokning osv.
    {
        ...
        void WriteBookingObjectFile(List<IBookingObject> BookableObjects);
